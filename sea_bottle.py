...
s_y = 10
step_x = size_canvas_x // s_x  # по горизонтали
step_y = size_canvas_y // s_y  # по вертикали
...
def on_closing():
    global app_running
    if messagebox.askokcancel("Exit","Do you want exit?"):
        app_running = False
        tk.destroy()
...
b0 = Button(tk, text="Корабли Игрока №1", command=button_show_enemy1)
b0.place(x=size_canvas_x + 20, y=30)

b1 = Button(tk, text="Корабли Игрока №2", command=button_show_enemy2)
b1.place(x=size_canvas_x + 20, y=70)

b2 = Button(tk, text="Реванш!", command=button_begin_again)
